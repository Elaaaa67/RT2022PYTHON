debut = int(input("Entrez le début de la location (un entier) : "))
fin = int(input("Entrez la fin de la location (un entier) : "))
x = 0
tarifstandard = 0
tarifmajore = 0
...
while debut == fin or debut > fin or debut < 0 or debut > 24 or fin > 24 or fin < 0:
    ...
    if debut > fin:
        print("Attention ! le début de la location est après la fin, c'est incohérent")
        print("\n")
        debut = int(input("Entrez le début de la location (un entier) : "))
        fin = int(input("Entrez la fin de la location (un entier) : "))
